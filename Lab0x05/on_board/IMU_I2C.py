...
class IMU_I2C:
    ...
    def changeOpMode(self, mode):  # Change operating status to "fusion" mode provided by BNO055
        self.I2C_Bus.mem_write(config_op_mode, self.address, op_mode_addr, timeout=5000, addr_size=8)
        # self.I2C_Bus.mem_write(mode, self.address, op_mode_addr, timeout=5000, addr_size=8)
